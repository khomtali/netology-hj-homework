...
2. [Способы поиска нужного HTML-элемента](./html-element-collection/) (выполнено)
3. [Объект события](./event-object/) (выполнено)
4. [Объектная модель документа](./dom/) (выполнено)
5. [Асинхронные HTTP-запросы](./xhr/) (выполнено)
6. [Работа с HTML-формами](./html-forms/) (выполнено)
